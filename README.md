...
**[Ver la Propuesta Detallada en la Wiki de GitHub](https://github.com/TU_USUARIO/TU_REPOSITORIO/wiki)**

---

## 🚀 Instrucciones de Compilación y Ejecución

Sigue estos pasos para clonar el repositorio, configurar el entorno y ejecutar el proyecto base:

### Prerrequisitos
1. Asegúrate de tener instalado **Java 17** o superior en tu sistema. Puedes verificarlo en tu terminal ejecutando:
   ```bash
   java -version
